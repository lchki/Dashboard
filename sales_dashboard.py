...
# -*- coding: utf-8 -*-
"""
Created on Tue Jul  4 15:44:19 2023
...
sales_by_product_line =df_selection["Total"] = df_selection["Total"].astype(float)  # Convertir la colonne "Total" en float
...
fig_product_sales.update_layout(plot_bgcolor="rgba(230, 230, 230, 0.5)")
